...
function showLove() {
  const messages = [
    `💖 Mas Sayang Adek 💖\nAdek adalah segalanya bagi mas!`,
    `⭐ Adek adalah bintang terindah dalam hidup mas ⭐\nYang selalu menerangi setiap langkah mas`,
    `💑 Bersama adek, setiap hari terasa seperti Valentine 💑\nKarena cinta adek membuat hidup mas sempurna`,
    `💕 You're my everything! 💕\nMy love, my life, my world!`,
    `🌈 Adek membuat hidup mas lebih berwarna 🌈\nSeperti pelangi yang indah setelah hujan`,
    `💫 Setiap detik bersama adek adalah keajaiban 💫\nHidup mas lebih indah karena ada adek!`,
    `🌹 Cinta kita seperti bunga yang selalu mekar, tak akan pernah layu 🌹\nAdek adalah wangi bunga yang selalu ada di hati mas`,
    `✨ Adek adalah impian yang jadi kenyataan ✨\nSaat mas menutup mata, mas hanya melihat adek`,
    `🌟 Adek adalah sinar dalam hidup mas, lebih terang dari bintang 🌟\nSetiap hari bersama adek adalah anugerah`,
    `💌 Tak ada kata yang cukup untuk menggambarkan rasa cintmas 💌\nSetiap detik denganmu adalah kebahagiaan yang tak ternilai`,
    `🌸 Hati mas milik adek 🌸\nTak ada yang lebih indah selain cinta adek`,
    `💖 Adek adalah rumah hati mas 💖\nTempat mas kembali, tempat mas merasa aman dan dicintai`,
    `💓 Setiap sentuhan adek membuat dunia ini terasa lebih indah 💓\nCinta adek adalah kekuatan yang membuat mas hidup`,
    `🌷 Adek adalah keindahan yang tak ternilai 🌷\nSetiap tatapan adek adalah kebahagiaan bagi mas`,
    `🌹 Kehadiranmu membuat dunia ini lebih manis 🌹\nAdek adalah alasan mas tersenyum setiap hari`,
    `💞 Cinta adek adalah hadiah terbesar dalam hidup mas 💞\nTak ada yang bisa memisahkan kita!`,
    `💖 Adek membuat mas merasa sempurna 💖\nSetiap hari bersama adek adalah keajaiban yang mas tak ingin lewatkan`,
    `💘 Adek adalah hati mas yang berdetak 💘\nDan mas ingin hidup bersama adek selamanya`,
    `🌟 Tak ada yang lebih indah selain cinta kita 🌟\nAdek adalah bagian terbaik dari hidup mas`,
    `💎 Cinta kita lebih berharga dari permata 💎\nSetiap detik bersama adek adalah kenangan yang tak ternilai`,
    `🦋 Setiap momen bersama adek terasa seperti terbang di atas awan 🦋\nAdek adalah bagian dari kebahagiaan mas.`,
    `🌻 Dengan adek, mas merasa seperti bunga yang selalu mekar 🌻\nCinta adek adalah segalanya bagi hidup mas`,
    `💖 Cinta kita adalah perjalanan yang tak akan pernah berakhir 💖\nSetiap langkah mas selalu mengarah ke adek`,
    `💓 Adek adalah kekuatan dalam hidup mas 💓\nSaat adek ada di dekat mas, mas merasa bisa mengalahkan dunia`,
    `💑 Bersama adek, hidup ini penuh dengan tawa dan kebahagiaan 💑\nAdek adalah teman terbaik, kekasih terbaik, dan segalanya bagi mas`,
    `🌸 Tiada yang lebih indah selain melihat senyuman adek 🌸\nKarena senyuman adek adalah sumber kebahagiaan mas`,
    `💖 Dalam dunia ini, hanya ada adek dan mas 💖\nCinta adek adalah segalanya yang mas perlukan`,
  ];
...
function updateLoveCounter() {
  const startDate = new Date("2026-01-05"); // Ganti dengan tanggal anniversary Anda YYYY-MM-DD
  const today = new Date();
  const diffTime = Math.abs(today - startDate);
  const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));
  document.getElementById("loveCounter").innerHTML = `
        <p style="font-size: 1.5em; margin: 10px 0;">
            ${diffDays} Hari Penuh Cinta ❤️<br />I Love You More Sayanggg
        </p>
    `;
}
...
const gifs = [
  "./image/bear-kiss-bear-kisses.gif",
  "./image/lovecutie0.gif",
  "./image/lovecutie1.gif",
  "./image/lovecutie2.gif",
  "./image/lovecutie3.gif",
  "./image/lovecutie4.gif",
  "./image/lovecutie7.gif",
  "./image/lovecutie9.gif",
  "./image/cutieSwal2.gif",
  "./image/cutieSwal3.gif",
  "./image/cutieSwal4.gif"
];
